...
"syn keyword htmlTagName2 body head header footer script html style
syn keyword htmlTagName1 input select textarea optgroup fieldset 
syn keyword htmlTagName2 form
syn keyword htmlTagName3 tbody thead tfoot caption
syn keyword htmlTagName4 tr td th
syn keyword htmlTagName5 table
...
syn region  htmlTag                start=+<[^/]+   end=+>+ fold contains=htmlTagN,htmlString,htmlArg,htmlArg2,htmlArg3,htmlValue,htmlTagError,htmlEvent,htmlCssDefinition,@htmlPreproc,@htmlArgCluster
syn match   htmlTagN     contained +<\s*[-a-zA-Z0-9]\++hs=s+1 contains=htmlTagName,htmlTagName1,htmlTagName2,htmlTagName3,htmlTagName4,htmlTagName5,htmlSpecialTagName,@htmlTagNameCluster
syn match   htmlTagN     contained +</\s*[-a-zA-Z0-9]\++hs=s+2 contains=htmlTagName,htmlTagName1,htmlTagName2,htmlTagName3,htmlTagName4,htmlTagName5,htmlSpecialTagName,@htmlTagNameCluster
...
syn keyword htmlTagName contained big blockquote br center
syn keyword htmlTagName contained cite code dd dfn dir div dl dt font
"syn keyword htmlTagName contained form hr html img
syn keyword htmlTagName contained hr img
"syn keyword htmlTagName contained input isindex kbd li link map menu
syn keyword htmlTagName contained isindex kbd li link map menu
syn keyword htmlTagName contained meta ol option param pre p samp span
"syn keyword htmlTagName contained select small sub sup
syn keyword htmlTagName contained small sub sup
"syn keyword htmlTagName contained table td textarea th tr tt ul var xmp
syn keyword htmlTagName contained tt ul var xmp
"syn match htmlTagName contained "\<\(b\|i\|u\|h[1-6]\|em\|strong\|head\|body\|title\)\>"
syn match htmlTagName contained "\<\(b\|i\|u\|h[1-6]\|em\|strong\|title\)\>"

" new html 4.0 tags
syn keyword htmlTagName contained abbr acronym bdo button col label
"syn keyword htmlTagName contained colgroup fieldset iframe ins legend
syn keyword htmlTagName contained colgroup iframe ins legend
"syn keyword htmlTagName contained object optgroup q s tbody tfoot thead
syn keyword htmlTagName contained object q s
...
syn keyword htmlTagName contained figure hgroup keygen main
...
syn match   htmlArg2 contained  "th:[a-zA-Z0-9_]*"
syn keyword htmlArg3 contained  selected checked required multiple
syn match	thymeleaf  "\[\[[\$\#\*\~@]{[^{}]*}\]\]"
...
syn keyword htmlArg contained cellspacing class clear code codebase color
...
syn keyword htmlArg contained rel rev rows rowspan scrolling shape onclick
...
syn keyword htmlArg contained nohref nowrap object profile readonly
...
syn keyword htmlArg contained radiogroup reversed sandbox spellcheck
...
syn keyword htmlSpecialTagName  contained script style body header head html
...
hi def link htmlEndTag                  HtmlEndTag
"hi def link htmlArg                     Type
hi def link htmlArg                     HtmlArg
hi def link htmlArg2                    HtmlArg2
hi def link htmlArg3                    HtmlTag1
hi def link thymeleaf                   HtmlArg2
hi def link htmlTagName                 htmlStatement
hi def link htmlTagName1                htmlStatement1
hi def link htmlTagName2                htmlStatement2
hi def link htmlTagName3                htmlStatement3
hi def link htmlTagName4                htmlStatement4
hi def link htmlTagName5                htmlStatement5
"hi def link htmlSpecialTagName          Exception
hi def link htmlSpecialTagName          htmlSpecialTagName
...
hi def link htmlString             HtmlString
"hi def link htmlStatement          Statement
hi def link htmlStatement          HtmlTag
hi def link htmlStatement1         HtmlTag1
hi def link htmlStatement2         HtmlTag2
hi def link htmlStatement3         HtmlTag3
hi def link htmlStatement4         HtmlTag4
hi def link htmlStatement5         HtmlTag5
hi def link htmlComment            HtmlComment
